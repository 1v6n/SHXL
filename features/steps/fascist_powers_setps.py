...
def step_juego_fascista_inicializado(context):
    ...
    context.game.state.board.policies = ["Liberal", "Fascist", "Liberal", "Fascist", "Liberal"]
...
def step_politicas_fascistas_mazo(context, cantidad):
    ...
    context.game.state.board.policies = ["Liberal", "Fascist", "Liberal", "Fascist", "Liberal"][:cantidad + 2]
...
def step_verificar_indice_fascista_retorno(context):
    ...
    assert context.game.state.special_election_return_index == context.game.state.president.id
